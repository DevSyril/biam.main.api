...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('templates', function (Blueprint $table) {
            $table->foreign(['author_id'], 'templates_author_id_fkey')->references(['id'])->on('users')->onUpdate('no action')->onDelete('no action');
    ...
    {
        Schema::table('templates', function (Blueprint $table) {
            $table->dropForeign('templates_author_id_fkey');
