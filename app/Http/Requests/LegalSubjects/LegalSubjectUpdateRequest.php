...
class LegalSubjectUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'sometimes|nullable|string|max:255|unique:pgsql_secondary.legal_subject,slug',
            'parent_id' => 'sometimes|nullable|uuid|exists:pgsql_secondary.legal_subject,id',
